        ...
        while (isRunning) {
            ...
            switch (choice) {
                case 1:
                    ...
                    if (salon.isValidDate(date)) {
                        ArrayList<String> availableTimes = salon.getAvailableTimes(date);
                        System.out.println("Available Times for " + date + ":");
                        ...
                        if (availableTimes.contains(selectedTime)) {
                            Appointment newAppointment = new Appointment(customerName, date, selectedTime);
                ...
                case 3:
                    ...
                    if (moneyEarned > 0.0) {
                        ...
                        saveTotalMoney(totalMoney, "totalMoney.txt");
                    } else {
